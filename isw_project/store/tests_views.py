...
from .views import ProductListView, CustomerLoginView, CartView, FilterProductsView


class ProductListViewTest(TestCase):
    def setUp(self):
        self.product1 = Product.objects.create(name='iPhone 14 PRO', price=17.17)
        self.product2 = Product.objects.create(name='Apple Watch ULTRA', price=20)
        self.product3 = Product.objects.create(name='iPad PRO', price=09.99)

        self.user = User.objects.create_user(username='wakaflocka17', password='wakawaka')

        self.factory = RequestFactory()
        self.request = self.factory.get(reverse('product_list'))
    ...
    def test_product_list_view(self):
        ...
        product_list = response.context_data['product_list']
        ...
        customer = response.context_data['customer']
        self.assertEqual(customer, self.user.customer)
